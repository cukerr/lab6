...
public class MyOwnAutoShop implements Admin, Customer {
    ...
    public MyOwnAutoShop() {
        cars[0] = new Sedan(150, true, 190000, "Белый", 22);
        cars[1] = new Ford(100, false, 200000, "Красный", 2021, 1000);
        cars[2] = new Ford(110, true, 170000, "Синий", 2023, 500);
        cars[3] = new Truck(120, false, 255000, "Черный", 3200);
        cars[4] = new Truck(120, true, 220000, "Серый", 2600);
    }
